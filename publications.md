...
- Neutrality for Sustainability: The Promise of Neutral Hosts for Sustainable Mobile Networks <a href="https://research.utwente.nl/en/publications/neutrality-for-sustainability-the-promise-of-neutral-hosts-for-su/" target="_blank">[paper]</a></br>
Boris Gerretzen and Suzan Bayhan</br>
The International Conference on ICT for Sustainability (ICT4S) 2026. 

- SoK: Understanding the state of IoT-specific vulnerabilities via CVE characterization with LLIoT</br>
Tina Rezaei, S.Bayhan, A.Continella, J.v.d.Ham, R.v.Rijswijk-Deij</br>
...
T. Meuser, L Lovén, M Bhuyan, SG Patil, S Dustdar, A Aral, Suzan Bayhan, et al.
IEEE Internet Computing 2024

- ODESA: Load-Dependent Edge Server Activation for Lower Energy Footprint
Blas Gómez Mora, Suzan Bayhan, Estefania Coronado, Jose Villalon, Antonio Garrido
IEEE WCNC 2024

- National roaming as a fallback or default? 
Lotte Weedage, Syllas R. C. Magalhaes, Suzan Bayhan
IFIP Networking Workshop on IOCRCI, 2023
